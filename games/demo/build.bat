...
%CC% -DSDL_MAIN_HANDLED -I%SWEET% -I%SDL%\include -I%IMAGE%\include -I%MIXER%\include -I%TTF%\include -L%SDL%\lib -L%IMAGE%\lib -L%MIXER%\lib -L%TTF%\lib -lSDL2 -lSDL2_image -lSDL2_ttf -lSDL2_mixer game.c -o game.exe
pause